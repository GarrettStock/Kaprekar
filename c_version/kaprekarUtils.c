...
int isKaprekar(int n) {
  ...
  if(n < 1) {
  	//undeclared use of the term "false."
    return 0;
  }
  ...
  //undeclared use of "numberOfDigits." The registered term is "numDigits."
      for(i=1; i<=numDigits; i++) {
    //increase the modulus by a factor of 10
    //found a typo of the variable "modulus." Was typed out as undeclared "modulous."
    modulus *= 10;
